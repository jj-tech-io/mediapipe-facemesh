...
if __name__ == "__main__":
    ...
    #names neutral and anger files

    anger_files = [os.path.join(anger_directory, file) for file in anger_files]
    neutral_files = [os.path.join(neutral_directory, file) for file in neutral_files]
    files = anger_files + neutral_files
    ...
    for file in files:
        ...
        print(file)
        name = os.path.basename(file).split(".")[0].split("/")[-1]
        print(name)
        print(file)
        ...
        ax = imshow(PIL.Image.fromarray(img).convert('RGB'))
        ...
        obj_name =  os.path.join(r"/Users/joeljohnson/Documents/Encoder_Decoder/mediapipe-facemesh/emotions/objects", f"{name}.obj")
        texture_name = os.path.join(r"/Users/joeljohnson/Documents/Encoder_Decoder/mediapipe-facemesh/emotions/objects", f"{name}.png")
